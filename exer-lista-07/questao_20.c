/*Escreva um programa que leia duas matrizes 10x10 e passe-as para uma função que deve retornar
1 se as matrizes são iguais e 0 em caso contrario. A função principal imprime uma mensagem
